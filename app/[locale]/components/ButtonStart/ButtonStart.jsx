...
const ButtonStart=()=>{
    return (
        <div className={style.containerStartButton}>
             <Link style={{width:'10%'}} className={style.linkStartButton} locale="en" href={`works`}><Button variant="outlined"  sx={{ color: 'gray', backgroundColor: 'transparent', borderColor: 'gray', padding:'6%' }} >Start</Button></Link>
