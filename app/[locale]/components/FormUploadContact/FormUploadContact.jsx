...
export default function FormUploadContact() {
...
return (
    <>
   {!newForm && <Button onClick={onHandlerClick} variant="contained" style={{marginTop:'12px'}}>Subir Nueva vía de comunicación  ↑</Button>}
    {newForm && 
