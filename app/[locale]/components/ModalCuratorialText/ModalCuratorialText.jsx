   ...
   return(
        <Box>
            <Modal className={stylesMobile.modalContainer}  open={open} onClose={onClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
             ...
             <Item >
     {/*          <div style={{width:'50%'}}> */}
                <embed className={stylesMobile.doc} src={(exhibitionText.document)} width={1200} height={500} priority style={{styleText}} columns={{ xs: 1, sm: 1, md: 9, xl:3 }}  direction="row" justifyContent="center" alignItems="center"/>
           {/*    </div> */}
             </Item>
