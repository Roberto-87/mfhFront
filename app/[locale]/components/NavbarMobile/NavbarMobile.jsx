...
import { Toolbar, Typography, IconButton, Drawer, List, ListItem,  Box } from '@mui/material';
...
const Navbar =() => {
  ...
  <List sx={{ width: '100vw', marginTop:'10%'}}   >
    ...
    <ListItem  className={styles.animatedListItem} style={{ animationDelay: '0.3s' }} onClick={toggleDrawer}>
        <Link className={styles.linkNavbarMobile}  href={'/text'}>   {currentPathname==='/text'?<strong>TEXTS</strong>: 'TEXTS'}</Link>
    </ListItem>
