    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <div style={{display:'flex', flexDirection:'row-reverse'}}>
         <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
            <SwiperSlide ><button style={{position:'relative',cursor:'pointer', bottom:'50%', left:'1px'}} onClick={onPrevious}><GrPrevious/></button> <img style={{width:'60%'}} src={imageActive} alt={work.title}   onMouseLeave={handleZoom}  onMouseEnter ={handleZoom} zoom="200" /><button onClick={onNext} style={{position:'relative', bottom:'50%',cursor:'pointer', left:'2px'}}><GrNext/></button></SwiperSlide>
           </Swiper>
     </div>
